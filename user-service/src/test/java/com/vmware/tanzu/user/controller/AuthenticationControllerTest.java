package com.vmware.tanzu.user.controller;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

import com.vmware.tanzu.user.configuration.ServiceTestConfiguration;
import com.vmware.tanzu.user.controller.AuthenticationController;
import com.vmware.tanzu.user.domain.AuthenticationRequest;
import com.vmware.tanzu.user.exception.AuthenticationException;
import com.vmware.tanzu.user.service.UserService;
